...
li {
    ...
    <body>
<div class="container">
      <h1 class="text-center">C-Programming</h1><a class="btn" href="c-1-2.php" style="float:right">Next<span class="glyphicon glyphicon-chevron-right"></span></a> 
      <h2>Introduction : </h2>
      <ul>
    <li>C is a programming language developed at AT & T’s Bell
          Laboratories of USA in 1972. It was designed and written by a
          man named Dennis Ritchie.Possibly why C seems so popular is because it is reliable, simple
          and easy to use</li>
    <li>The advantages of C language are :
          <ol>
        <li>I believe that nobody can learn C++ or Java directly. This is
              ...
              find it worth the trouble.</li>
        <li>C++, C# or Java make use of a principle called Object
        ...
        <li>Though many C++ and Java based programming tools and
              ...
              why one should learn C before C++, C# or Java.</li>
        <li>Major parts of popular operating systems like Windows,
              ...
              programs. These programs are exclusively written in C.</li>
              <li>Mobile devices like cellular phones and palmtops are
...
while building such operating systems and programs.</li>
<li>You must have seen several professional 3D computer games
...
frameworks have been built using C language.</li>
<li>At times one is required to very closely interact with the
...
the programmer.</li>
      ...
      <h2>Getting started : </h2><img src="img/C-1.PNG" class="img-responsive"> 
      <h2>Rules for forming Identifiers : </h2>
      <ul><li>A variable name is any combination of 1 to 31 alphabets,
...
effort.</li>
<li>The first character in the variable name must be an alphabet or
underscore.</li>
<li>No commas or blanks are allowed within a variable name.</li>
<li>No special symbol other than an underscore (as in gross_sal)
can be used in a variable name.<br>
Ex.: si_int ,
m_hra ,
pop_e_89 <br></li>
</ul>
<h2>C keywords : </h2>
<ul><li>Keywords are the words whose meaning has already been
...
not allowed by the computer.</li><li>There are only 32 keywords available in C.</li></ul><img src="img/C-2.PNG" class="img-responsive">
    </div>
