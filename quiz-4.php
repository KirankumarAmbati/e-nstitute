...
if(isset($_POST['submit']))
{
	...
	$sql = "UPDATE users SET c_marks='$totalCorrect',c_status=4 WHERE u_email='$email'";	
...
<body>
<h1 class="text-center">Week-4 Quiz</h1>
...
<center><input class="btn butn-orange" type="submit" value="Submit Quiz" name="submit"/></center><br><br><br><br>
</form>
