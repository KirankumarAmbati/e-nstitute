...
if(isset($_POST['submit']))
{
	...
	if($totalCorrect>6){echo "<script>alert($totalCorrect)</script>";
	$email=$_SESSION['email'];
	$sql = "UPDATE users SET c_marks='$totalCorrect',c_status=1 WHERE u_email='$email'";	
...
<body>
<h1 class="text-center">Week-1 Quiz</h1>
...
<center><input class="btn butn-orange" type="submit" value="Submit Quiz" name="submit"/></center><br><br><br><br><br>
</form>
